...
def ensure_default_integrations() -> None:
    definitions = [
        {
            "slug": "openai",
            "name": "OpenAI",
            ...
            "config_fields": [
                ...
                {"key": "model", "label": "Default Model", "type": "select", "options": ["gpt-4o", "gpt-4-turbo", "gpt-3.5-turbo"], "required": True},
            ],
        },
        {
            "slug": "claude",
            ...
            "config_fields": [
                {"key": "api_key", "label": "API Key", "type": "password", "required": True},
                {"key": "model", "label": "Default Model", "type": "select", "options": ["claude-opus-4-5", "claude-sonnet-4-5", "claude-haiku"], "required": True},
            ],
        },
        {
            "slug": "gemini",
            ...
            "config_fields": [
                {"key": "api_key", "label": "API Key", "type": "password", "required": True},
                {"key": "model", "label": "Default Model", "type": "select", "options": ["gemini-1.5-pro", "gemini-1.5-flash", "gemini-pro"], "required": True},
            ],
        },
        {
            "slug": "figma",
        ...
        },
        {
            ...
            "config_fields": [
                ...
                {"key": "default_branch", "label": "Default Branch", "type": "text", "required": False, "default": "main"},
            ],
        },
        {
            "slug": "aws",
            ...
            "config_fields": [
                ...
                {"key": "region", "label": "Region", "type": "select", "options": ["us-east-1", "us-west-2", "eu-west-1", "ap-south-1"], "required": True},
